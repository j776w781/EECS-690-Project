...
def detect_pins_by_scanning(binary, chip_x, chip_y, chip_w, chip_h,
                            scan_offset, scan_shift_to_edge, min_pin_thickness, margin, 
...
if __name__ == "__main__":
    ...
    img2_body = make_bw(img, thresh_value=120)
    img2_strict = make_bw(img, thresh_value=243)  
    img2_loose = make_bw(img, thresh_value=220)  
